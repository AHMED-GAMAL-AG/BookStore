                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <select id="category" class="form-control" name="category">
                                ...
                                <option disabled {{ $book->category == null ? 'selected' : '' }}>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="authors" multiple class="form-control" name="authors[]">
                                <option disabled {{ $book->authors()->count() == 0 ? 'selected' : '' }}>
                                    {{ __('Choose authors') }}</option>

                                @foreach ($authors as $author)
                                    <option
                                        value="{{ $author->id }}"{{ $book->authors->contains($author) ? 'selected' : '' }}>
                                        {{ $author->name }}</option>
                                @endforeach
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <select id="publisher" class="form-control" name="publisher">
                                ...
                                <option disabled {{ $book->publisher == null ? 'selected' : '' }}>
                                    {{ __('Choose a publisher') }}</option>
